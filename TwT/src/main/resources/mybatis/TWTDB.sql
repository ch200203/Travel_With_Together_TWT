...
SELECT MAX(TO_NUMBER(ltrim(sr_code,'SR'))) FROM SCHEDULEREVIEW;

SELECT MAX(SR_CODE) FROM SCHEDULEREVIEW;
...
-- 여행일정 샘플
INSERT INTO "TRAVELSCHEDULE" (TS_CODE, M_CODE, TP_CODE, TS_TITLE, TS_SDAY, TS_THEME, TS_PEOPLE, TS_THUM, TS_PERIOD, TS_DATE) VALUES ('TS1', 'M1', 'TP1', '테스트일정1', TO_DATE('2020-02-18', 'YYYY-MM-DD'), '여행테마', '1', 'THUM.JPG', 3, SYSDATE);
INSERT INTO "TRAVELSCHEDULE" (TS_CODE, M_CODE, TP_CODE, TS_TITLE, TS_SDAY, TS_THEME, TS_PEOPLE, TS_THUM, TS_PERIOD, TS_DATE) VALUES ('TS2', 'M1', 'TP1', '테스트일정2', TO_DATE('2020-02-18', 'YYYY-MM-DD'), '여행테마', '1', 'THUM.JPG', 3, SYSDATE);
